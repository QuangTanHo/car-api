...
public class FileStorageController {
    ...
    @PostMapping("/un_auth/files/get_info_file_type")
    ...
    @PostMapping("/un_auth/files/get_info_file_storage/list")
    ...
    @DeleteMapping("/un_auth/files/multi/delete")
    ...
    @GetMapping(value = "/un_auth/file_name/download/original/{fileName}", produces = {MediaType.IMAGE_JPEG_VALUE})
    @ResponseBody
    ...
    @PostMapping("/un_auth/files/get_all_file")
